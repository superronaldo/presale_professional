...
const path_list = ['', 'dashboard', 'profitshare', 'swap', 'nft_savings', 'm_control/admin'];
      ...
      >
        ...
        <div className="navbar-content">
          <div className='logo-img flex flex-col space-y-2 items-center pb-0' style={{ padding: '15px 30px' }}>
            <a href="https://goldcopytrade.io/">
              <img alt='' src={'/img/logo.gif'} className='w-36' style={{ cursor: 'pointer' }} />
            </a>
            <span className='fs-24 f-century text-green m-0'></span>
            <p className='fs-14 m-0' style={{ color: '#919BB5' }}></p>
            <p className='fs-20 text-white'></p>
            <p className='fs-14 m-0' style={{ color: '#919BB5' }}></p>
          </div>
          ...
          <nav>
              ...
              <>
                ...
                >
                  <div className='flex space-x-6 align-items-center'>
                    <i className="fa-light fa-home fs-20"></i>
                ...
                <Link
                  to='/profitshare'
                  className={`menu-item ${navSelected === 'profitshare'
                    ? 'menu-active-item block py-2 px-4 transition duration-200  text-white'
                    : 'block py-2 px-4 transition duration-200  hover:text-white'
                    }`}
                >
                  <div className='flex space-x-6 align-items-center'>
                    <i className="fa-light fa-chart-pie fs-20"></i>
                    <div className='menu-text text-lg'>Profit Sharing</div>
                  </div>
                </Link>
                {/* <Link
                  to='/swap'
            ...
            <a
              href="http://goldcopytrade.io/wp-content/uploads/2022/09/Whitepaper.pdf"
              rel="noreferrer"
              target='_blank'
            ...
            >
              <div className='flex space-x-6 align-items-center'>
                <i className="fa-light fa-book fs-20"></i>
            ...
            <div className="flex flex-column">
              <div className="sidebar-social-icons social-icons flex justify-content-center">
                ...
                <a href="https://t.me/Goldcopytradeofficial" target="_blank" rel="noreferrer"><i className="fa-brands fa-telegram"></i></a>
                <a href="https://discord.gg/" target="_blank" rel="noreferrer"><i className="fa-brands fa-discord"></i></a>
              </div>
            </div>
          </nav>
        </div>
        <div className='align-self-center text-white' align="center">
          <p>Copyright © 2022<br />GoldCopyTrade, LLC</p>
