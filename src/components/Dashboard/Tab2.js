...
import usdt_img from './../../assets/img/icon/tether-usdt-logo.svg';
...
function Tab2(props) {
    ...
    const handleClickBuy = () => {
        props.handleBuyWithUsdt(usdt)
    }

    const handleChangeUSDT = async (event) => {
        setUsdt(Number(event.target.value));
        setGpwr(Number(event.target.value) * props.tokenRates);
    }
    const handleChangeGPWR = async (event) => {
        setUsdt(Number(event.target.value) / props.tokenRates);
        ...
        <div>
            <div className="row mt-3 p-3">
                ...
                <div className="col-md-8 text-center">
                    <h5><strong>{props.tokenRates} GPWR = 1 USDT</strong></h5>
                </div>
                <div className="col-md-2">
                    <img src={usdt_img} className='logo-img mx-auto' alt="usdt-img" />
                </div>
            </div>
            <div className="row">
            ...
            <div className="row pt-3">
                <div className="col-md-12">                    
                    <div className="progress">  
                        <div className="progress-bar bg-danger progress-status text-center" id="progressbar_2" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                        </div>                        
                    </div>
                </div>
            </div>
            ...
            <div className="row pt-3">
                <div className="col-md-12 text-center">
                    <h5><strong>AMOUNT RAISED&nbsp;:&nbsp;{props.presaleAmount}&nbsp;USDT</strong></h5>
                </div>
            </div>
            ...
            <>
                {
                    pending ? (
                        ...
                        <div className="row pt-3 px-5">
                            <h6 className="text-center">Your USDT Amount&nbsp;&nbsp;:&nbsp;&nbsp;{balance.usdtBalance}</h6>
                            <div className="col-md-4 mb-2 text-center align-self-end">
                                <input type="number" name="usdt" placeholder="0.0" min="1" max="50000" value={usdt} className="input-class w-100" onChange={handleChangeUSDT} />
                                <label>USDT</label>
                            </div>
                            <div className="col-md-4 mb-2 text-center align-self-end">
