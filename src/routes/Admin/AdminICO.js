...
const AdminICO = (props) => {
  ...
  const receiver_Validation = () => {
    ...
    else if (isEmpty(input_data.x_astro_receiver)) {
      $(`input[name='x_astro_receiver']`).focus();
      result = false;
    }
  ...
  const fee_Validation = () => {
    ...
    else if (isEmpty(input_data.x_astro_fee)) {
      $(`input[name='x_astro_fee']`).focus();
      result = false;
    }
                    ...
                    <div className='row gap-row-2'>
                      ...
                      <div className='col-md-6'>
                        <div className='flex flex-column'>
                          ...
                          <input name="x_astro_receiver" type="text" onChange={handleChange}></input>
                        </div>
                      </div>
                      <div className='col-md-6'>
                        <div className='flex flex-column'>
                    ...
                    <div className='row gap-row-2'>
                      ...
                      <div className='col-md-6'>
                        <div className='flex flex-column'>
                          ...
                          <input name="x_astro_fee" type="number" onChange={handleChange}></input>
                        </div>
                      </div>
                      <div className='col-md-6'>
                        <div className='flex flex-column'>
